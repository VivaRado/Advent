...
if  project_root_folder == None:
    ...
    project_root_folder = path.abspath(os.path.join(path.join(this_file ,"../../"),'kerning'))
    #
...
def readNameYaml(filename, dstMap):
    ...
    srcFile = os.path.abspath(os.path.join(project_root_folder, 'data', filename)) # TFSProject.findProjectRootFolder()
...
def readGlyphNames_AdobeGlyphListForNewFonts():
    ...
    #
    srcFile = os.path.abspath(os.path.join(project_root_folder, 'data', 'Adobe Glyph List', 'aglfn13.txt'))
    print('srcFile',srcFile)
    if not os.path.exists(srcFile) and os.path.isfile(srcFile):
        raise Exception ('Missing srcFile: ' + srcFile)
...
def readGlyphNames_AdobeGlyphListFull():
    #import tfs.common.TFSProject as TFSProject
    srcFile = os.path.abspath(os.path.join(project_root_folder, 'data', 'Adobe Glyph List', 'glyphlist.txt'))
    readGlyphNames_short(srcFile)

def readGlyphNames_typefaceExtra():
    #import tfs.common.TFSProject as TFSProject
    srcFile = os.path.abspath(os.path.join(project_root_folder, 'data', 'typefacet_extra_glyphlist.txt'))
    readGlyphNames_short(srcFile)
...
def readCodeBlocks():
    #import tfs.common.TFSProject as TFSProject
    srcFile = os.path.abspath(os.path.join(project_root_folder, 'data', 'UnicodeCodeBlocks.yaml'))
#    print 'srcFile', srcFile
    if not os.path.exists(srcFile) and os.path.isfile(srcFile):
        raise Exception ('Missing srcFile: ' + srcFile)
