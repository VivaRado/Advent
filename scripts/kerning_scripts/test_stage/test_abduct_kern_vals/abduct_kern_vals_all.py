...
def make_fea_class_lines(p_g):
	...
	return all_kern_flc
#
def make_kern_lines_dict(f_kern_data):
	#
	all_kern_plist = ''
	plist_strings = ''
	#
...
def do_adbuct(p_groups, p_kerning, dir_to_comp_ufo_file):
	...
	#
	class_kerning_plist = make_kern_lines_dict(final_class_kern_pairs)
	#
...
parser.add_argument("-f", "--fontfile", dest="fontfile", 
                    help="The font filename of the UFOs without the weights, example filename: fontname")
